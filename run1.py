...
if __name__ == "__main__":
    ...
    # hpc229 hpc236 hpc230 hpc230 hpc239 hpc239 hpc228 hpc228 hpc246 hpc224 hpc224 hpc224 hpc237 hpc237 hpc237
    hosts = ['hpc246.hpc.sydney.edu.au',
             'hpc228.hpc.sydney.edu.au',
             'hpc228.hpc.sydney.edu.au',
             'hpc229.hpc.sydney.edu.au',
             'hpc236.hpc.sydney.edu.au',
             'hpc230.hpc.sydney.edu.au',
             'hpc230.hpc.sydney.edu.au',
             'hpc239.hpc.sydney.edu.au',
             'hpc239.hpc.sydney.edu.au',
             'hpc224.hpc.sydney.edu.au',
             'hpc224.hpc.sydney.edu.au',
             'hpc224.hpc.sydney.edu.au',
             'hpc237.hpc.sydney.edu.au',
             'hpc237.hpc.sydney.edu.au',
             'hpc237.hpc.sydney.edu.au',
             'hpc219.hpc.sydney.edu.au']
    ...
    for ni in range(len(uniq_hosts)-1, -1, -1):
        ...
        command_remote = 'NNODES={} MASTER_ADDR={} MASTER_PORT={} NODE_RANK={} GPUS_PER_NODE={} ./tools/run_dist_launch.sh {} {} {}'.format(
            args.nnodes, HOST_IP[hosts[0]], str(args.master_port), ni, args.nproc_per_node, str(args.nnodes*args.nproc_per_node), args.training_script, " ".join(args.training_script_args))
        ...
        command = './tools/run_dist_launch.sh {} {} {}'.format(str(args.nnodes*args.nproc_per_node), args.training_script, " ".join(args.training_script_args))
        if ni == 0:
